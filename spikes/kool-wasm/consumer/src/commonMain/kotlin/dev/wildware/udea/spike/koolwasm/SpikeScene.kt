...
private const val FRAMES_BEFORE_READY = 60
 ...
 */
private fun readyLine(frames: Int, backend: String, api: String) =
 ...
 */
internal fun KoolApplication.spikeScene(onReady: (String) -> Unit) {
    addScene {
...
private val SPIKE_CLEAR = Color(0.05f, 0.25f, 0.3f, 1f)
