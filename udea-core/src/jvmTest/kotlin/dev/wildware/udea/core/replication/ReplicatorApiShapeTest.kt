...
class ReplicatorApiShapeTest {
    ...
    fun `the only overridable FieldMask properties are the frozen Replicator's`() {
        ...
        val declarations = ModuleFiles.mainSources
            .flatMap { file -> maskPropertyNames(ModuleFiles.relativePath(file), file.readText()) }
            .sorted()

        assertEquals(
            listOf(
                "udea-core/src/commonMain/kotlin/dev/wildware/udea/core/replication/FieldMask.kt:ALL",
                "udea-core/src/commonMain/kotlin/dev/wildware/udea/core/replication/FieldMask.kt:EMPTY",
                "udea-core/src/commonMain/kotlin/dev/wildware/udea/core/replication/Replicator.kt:allMask",
                "udea-core/src/commonMain/kotlin/dev/wildware/udea/core/replication/Replicator.kt:netMask",
            ),
            declarations,
