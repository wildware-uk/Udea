 ...
 *
 * The default seed is the wall clock's current instant. Two runs of the same replay produce different
...
public class PresentationRandom private constructor(private val random: Random) {
    ...
    public constructor() : this(Random(Clock.System.now().let { it.epochSeconds * NANOS + it.nanosecondsOfSecond }))
    ...
    public companion object {
        ...
        private const val NANOS: Long = 1_000_000_000L
