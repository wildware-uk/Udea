...
class MobaCharacterTest {
     ...
     * distinct colours. Delete a `spriteSheet(...)` from any `moba/game/assets/character/<name>.udea.kts`
     ...
     *
     * Change `orcScale` in `moba/game/assets/character/orc.udea.kts` and this fails - which is the
