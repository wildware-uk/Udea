 ...
 *
 * So: **nothing new goes here.** A new screen is a `@Composable` and a
...
public class Scene2dUiLayer(
    ...
    /** The stage every mounted [Scene2dUiScreen] lives in. */
    public val stage: Stage = stageFactory(viewport)

    /** Times [Stage.act] has been called. A health signal, and what `Scene2dUiLayerTest` counts. */
     ...
     */
    public fun show(screen: Scene2dUiScreen) {
        hide()
    ...
    private class Mounted(val screen: Scene2dUiScreen, val root: Actor)
