...
/** The module the pin is evaluated for, captured once for the lambdas below. */
val pinnedProjectPath: String = path
 ...
 */
configurations.matching { UdeaStdlibPin.isPinned(pinnedProjectPath, it.name) }.configureEach {
...
configurations.matching { UdeaStdlibPin.isPinned(pinnedProjectPath, it.name) }.all {
