 ...
 * the second match onwards. In this game that is the camera (`MobaLaunch.follow`) and the audio
 ...
 * if (newMatch.poll()) MobaLaunch.follow(rendering, MobaEntry.playerId(host))
 * ```
 *
