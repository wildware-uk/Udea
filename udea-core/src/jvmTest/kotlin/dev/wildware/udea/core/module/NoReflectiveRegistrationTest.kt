...
class NoReflectiveRegistrationTest {
    ...
    private companion object {
        ...
        /** A JVM module's test buckets, and a multiplatform module's `jvmTest` ones by their quoted name. */
        val TEST_CONFIGURATION =
            Regex("""^\s*"?(testImplementation|testRuntimeOnly|testCompileOnly|testFixtures\w*|jvmTest\w+)"?\s*\(""")
    }
}
