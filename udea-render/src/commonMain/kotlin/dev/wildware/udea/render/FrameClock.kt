...
public fun interface FrameClock {
    ...
    public companion object {
        ...
        /** The real clock: the platform's monotonic source, unaffected by wall-clock jumps. */
        public val Wall: FrameClock = WallFrameClock()
    }
}
...
/** Nanoseconds since this clock was made, from [TimeSource.Monotonic]. */
private class WallFrameClock : FrameClock {
    private val origin = TimeSource.Monotonic.markNow()
    override fun nanoTime(): Long = origin.elapsedNow().inWholeNanoseconds
}
