 ...
 *
 * Each one holds a GPU-backed object — a [SpriteRegion], a [SpriteClip] of them — and
...
public class SpriteRenderer(
    ...
    public var region: SpriteRegion? = null,
    ...
    public var tint: Rgba = Rgba.WHITE,
 ...
 *
 * [stateTime] is seconds because a [SpriteClip] is defined in seconds. That is legitimate — this is `udea-render`, one of the two places seconds exist
...
public class SpriteAnimation(
    ...
    public var animation: SpriteClip? = null,
