...
class NoReflectionInQueryPathTest {
    ...
    fun `the KClass exemption covers the owner pairing and nothing else`() {
        ...
        assertEquals(
            listOf(
                "udea-agent/src/commonMain/kotlin/dev/wildware/udea/agent/AgentStateSource.kt",
                "udea-agent/src/commonMain/kotlin/dev/wildware/udea/agent/AgentToolDef.kt",
                "udea-agent/src/commonMain/kotlin/dev/wildware/udea/agent/OwnerBinding.kt",
            ),
            importers.sorted(),
        )
        assertTrue(
