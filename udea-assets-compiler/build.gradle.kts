...
dependencies {
    ...
    // production reference to one of its types. Remove this line and scripts still compile, with
    // pass 1's syntactic check as the only loop check - and `AssetLoopResolutionTest` goes red.
