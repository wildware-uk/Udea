 ...
 * `udea-assets` to resolve `udea-annotations`, `udea-diagnostics`, kotlinx-io and the stdlib and
 * nothing else, and `kotlinx-serialization-cbor` is none of those. The rule is load-bearing rather
