...
public enum class DisconnectReason(internal val id: Int) {
    ...
    /**
     * The client could not open the connection at all: nothing listening, or no route. A
     * WebSocket client learns this from its connect failing (issue #209); a UDP client cannot
