...
internal object GasSources {
    ...
    /**
     * Every `.kt` file under every shipped source set: `commonMain` and each platform's `<name>Main`
     * (issue #204). A platform source set such as `jvmMain` is the one place a `System.nanoTime`
     * would still compile.
     */
